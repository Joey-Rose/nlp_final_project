    ...
    def __init__(self, fname):
        ...
        if fname.endswith(".bin"):
            ...
            with open(fname, "r", encoding='utf8') as f:
                for line in f:
                    s = line.split()
                    #changed it to go until 2nd to last since the vocab word was appended to the end of the word embedding lists I was making
                    v = np.array([float(x) for x in s[:len(s) - 1]])
