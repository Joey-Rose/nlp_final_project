...
regular_model = Word2Vec.load('regular_model.bin')
...
# with open('regular_embeddings.txt', 'w', encoding = 'utf-8') as f:
...
R = we.WordEmbedding('regular_embeddings.txt')
